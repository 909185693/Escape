 ...
 */
class FOnlineSessionEscape : public IOnlineSession
{
private:
	...
	/** Hidden on purpose */
	FOnlineSessionEscape() :
		EscapeSubsystem(NULL),
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferEscape& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferEscape& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferEscape& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferEscape& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemEscape& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionEscape(class FOnlineSubsystemEscape* InSubsystem) :
...
typedef TSharedPtr<FOnlineSessionEscape, ESPMode::ThreadSafe> FOnlineSessionEscapePtr;
