 ...
 */
class FOnlineExternalUIEscape : public IOnlineExternalUI
{
private:
...
PACKAGE_SCOPE:
	 ...
	 */
	explicit FOnlineExternalUIEscape(FOnlineSubsystemEscape* InSubsystem) :
...
public:
	 ...
	 * Destructor.
	 */
	virtual ~FOnlineExternalUIEscape()
	{
	}
...
typedef TSharedPtr<FOnlineExternalUIEscape, ESPMode::ThreadSafe> FOnlineExternalUIEscapePtr;
